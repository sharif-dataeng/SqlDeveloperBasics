...
*/
ALTER TABLE [Person].[StateProvince] WITH CHECK ADD CONSTRAINT [FK_StateProvince_CountryRegion]
...
ALTER TABLE [Person].[Address] WITH CHECK ADD CONSTRAINT [FK_Address_StateProvince]
  FOREIGN KEY([StateProvinceID]) REFERENCES [Person].[StateProvince]([StateProvinceID]);
ALTER TABLE [Person].[Address] CHECK CONSTRAINT [FK_Address_StateProvince];

ALTER TABLE [Person].[BusinessEntityAddress] WITH CHECK ADD CONSTRAINT [FK_BusinessEntityAddress_BusinessEntity]
...
ALTER TABLE [Person].[BusinessEntityAddress] WITH CHECK ADD CONSTRAINT [FK_BusinessEntityAddress_Address]
...
ALTER TABLE [Person].[BusinessEntityAddress] WITH CHECK ADD CONSTRAINT [FK_BusinessEntityAddress_AddressType]
...
ALTER TABLE [Person].[Person] WITH CHECK ADD CONSTRAINT [FK_Person_BusinessEntity]
  FOREIGN KEY([BusinessEntityID]) REFERENCES [Person].[BusinessEntity]([BusinessEntityID]);
ALTER TABLE [Person].[Person] CHECK CONSTRAINT [FK_Person_BusinessEntity];

ALTER TABLE [Person].[PersonPhone] WITH CHECK ADD CONSTRAINT [FK_PersonPhone_BusinessEntity]
  FOREIGN KEY([BusinessEntityID]) REFERENCES [Person].[BusinessEntity]([BusinessEntityID]);
ALTER TABLE [Person].[PersonPhone] CHECK CONSTRAINT [FK_PersonPhone_BusinessEntity];

ALTER TABLE [Person].[PersonPhone] WITH CHECK ADD CONSTRAINT [FK_PersonPhone_PhoneNumberType]
...
ALTER TABLE [Person].[EmailAddress] WITH CHECK ADD CONSTRAINT [FK_EmailAddress_BusinessEntity]
  FOREIGN KEY([BusinessEntityID]) REFERENCES [Person].[BusinessEntity]([BusinessEntityID]);
ALTER TABLE [Person].[EmailAddress] CHECK CONSTRAINT [FK_EmailAddress_BusinessEntity];

ALTER TABLE [Sales].[SalesTerritory] WITH CHECK ADD CONSTRAINT [FK_SalesTerritory_CountryRegion]
  FOREIGN KEY([CountryRegionCode]) REFERENCES [Person].[CountryRegion]([CountryRegionCode]);
ALTER TABLE [Sales].[SalesTerritory] CHECK CONSTRAINT [FK_SalesTerritory_CountryRegion];

ALTER TABLE [Sales].[Customer] WITH CHECK ADD CONSTRAINT [FK_Customer_Person]
  FOREIGN KEY([PersonID]) REFERENCES [Person].[BusinessEntity]([BusinessEntityID]);
ALTER TABLE [Sales].[Customer] CHECK CONSTRAINT [FK_Customer_Person];

ALTER TABLE [Sales].[Customer] WITH CHECK ADD CONSTRAINT [FK_Customer_SalesTerritory]
  FOREIGN KEY([TerritoryID]) REFERENCES [Sales].[SalesTerritory]([TerritoryID]);
ALTER TABLE [Sales].[Customer] CHECK CONSTRAINT [FK_Customer_SalesTerritory];

ALTER TABLE [HumanResources].[Employee] WITH CHECK ADD CONSTRAINT [FK_Employee_BusinessEntity]
  FOREIGN KEY([BusinessEntityID]) REFERENCES [Person].[BusinessEntity]([BusinessEntityID]);
ALTER TABLE [HumanResources].[Employee] CHECK CONSTRAINT [FK_Employee_BusinessEntity];

ALTER TABLE [HumanResources].[EmployeeDepartmentHistory] WITH CHECK ADD CONSTRAINT [FK_EmployeeDepartmentHistory_Employee]
...
ALTER TABLE [HumanResources].[EmployeeDepartmentHistory] WITH CHECK ADD CONSTRAINT [FK_EmployeeDepartmentHistory_Department]
...
ALTER TABLE [HumanResources].[EmployeeDepartmentHistory] WITH CHECK ADD CONSTRAINT [FK_EmployeeDepartmentHistory_Shift]
...
ALTER TABLE [Production].[ProductSubcategory] WITH CHECK ADD CONSTRAINT [FK_ProductSubcategory_ProductCategory]
...
ALTER TABLE [Production].[Product] WITH CHECK ADD CONSTRAINT [FK_Product_ProductSubcategory]
  FOREIGN KEY([ProductSubcategoryID]) REFERENCES [Production].[ProductSubcategory]([ProductSubcategoryID]);
ALTER TABLE [Production].[Product] CHECK CONSTRAINT [FK_Product_ProductSubcategory];

ALTER TABLE [Production].[Product] WITH CHECK ADD CONSTRAINT [FK_Product_ProductModel]
  FOREIGN KEY([ProductModelID]) REFERENCES [Production].[ProductModel]([ProductModelID]);
ALTER TABLE [Production].[Product] CHECK CONSTRAINT [FK_Product_ProductModel];
