IF DB_ID(N'AdventureWorkMock_Test') IS NOT NULL
BEGIN
    ALTER DATABASE [AdventureWorkMock_Test] SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
    DROP DATABASE [AdventureWorkMock_Test];
END
GO
CREATE DATABASE [AdventureWorkMock_Test];
GO
USE [AdventureWorkMock_Test];
GO
